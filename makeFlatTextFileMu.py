...
## PrintToTextFile("WmunuJets_CMSSW423-Summer11MC_WJets.root", "MC_WJets_WmunuJJ.txt");


## PrintToTextFile("ReducedTree/RD_WmunuJets_DataAll_GoldenJSON_1p1invfb.root", "Data_mu_1p2invfb.txt" )

PrintToTextFile("ReducedTree/RD_WmunuJets_CMSSW415-Spring11MC_WWToLNuQQ_M-160.root", "MC_HWW_160GeV_WmunuJJ.txt")
PrintToTextFile("ReducedTree/RD_WmunuJets_CMSSW415-Spring11MC_WWToLNuQQ_M-180.root", "MC_HWW_180GeV_WmunuJJ.txt")
############################################################
