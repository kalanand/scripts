...
void DrawL3()
{
  ...
  RespFit->SetRange(10,300);
  hCorUncertainty = new TH1F("CorrectionUncertainty","CorrectionUncertainty",300,1,301);
  hRespUncertainty = new TH1F("ResponseUncertainty","ResponseUncertainty",300,5,305);
  hCorFrac = new TH1F("FractionalCorrectionUncertainty","FractionalCorrectionUncertainty",5000,1,5001);
  hRespFrac = new TH1F("FractionalResponseUncertainty","FractionalResponseUncertainty",300,5,305);
  for(i=0;i<300;i++)
    {
      ...
      //       hCorUncertainty->SetBinContent(i+1,1);
      //       hCorUncertainty->SetBinError(i+1,0);
  ...
  leg->Draw();
  ////////////////////// Response ///////////////////////////////////////
  TCanvas *c_Response = new TCanvas("Response","Response",500,500);
  c_Response->cd(); 
  // gPad->SetLogx();
  ...
  /*
  TH1F *hClosure = new TH1F("hClosure","hClosure",100,5,305);
  for(int i=0;i<100;i++)
    {
      double dx = 5;
      double x = 3+dx*i;
